...
public class LaptopList extends AppCompatActivity {
    ...
    LaptopListAdapter adapter = null;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.laptop_list_activity);

        gridView = (GridView) findViewById(R.id.gridView);
        list = new ArrayList<>();
        adapter = new LaptopListAdapter(this, R.layout.laptop_items, list);
        gridView.setAdapter(adapter);

        // get all data from sqlite
        Cursor cursor = MainActivity.sqLiteHelper.getData("SELECT * FROM LAPTOP");
        list.clear();
        while (cursor.moveToNext()) {
            ...
            list.add(new Laptop(name, price, image, id));
        }
        ...
        gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                AlertDialog.Builder dialog = new AlertDialog.Builder(LaptopList.this);
                ...
                dialog.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int item) {
                        if (item == 0) {
                            // update
                            Cursor c = MainActivity.sqLiteHelper.getData("SELECT id FROM LAPTOP");
                            ArrayList<Integer> arrID = new ArrayList<Integer>();
                            while (c.moveToNext()){
                                arrID.add(c.getInt(0));
                            }
                            // show dialog update at here
                            showDialogUpdate(LaptopList.this, arrID.get(position));
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(LaptopList.this,Detail.class);
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        dialog.setTitle("Update Daftar Laptop");
    ...
    private void showDialogDelete(final int idTiens){
        final AlertDialog.Builder dialogDelete = new AlertDialog.Builder(LaptopList.this);
